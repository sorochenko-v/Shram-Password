            ...
            ZStack {
                ...
                List {
                    Section(header: Text("SUPPORT").foregroundColor(.gray)) {
                        Button {
                            openURL(URL(string: "https://boosty.to")!)
                        } label: {
                            HStack {
                        ...
                        Button {
                            openURL(URL(string: "https://www.donationalerts.com/r/sram")!)
                        } label: {
                            HStack {
                                Image(systemName: "gift.fill")
                                    .foregroundColor(.sramRed)
                                Text("Support via Donation (Donatello / Buy Me a Coffee)")
                                    .foregroundColor(.white)
                            }
                        }
                        .listRowBackground(Color(white: 0.12))
...
// MARK: - FileDocument conformant struct
        ...
        ZStack {
            ...
            VStack(spacing: 24) {
                Image(systemName: "heart.circle.fill")
                    .font(.system(size: 60))
                    .foregroundColor(.sramRed)
                Text("Sram Password is 100% free and local-only.\nIf you wish to support the development, consider supporting the authors.")
                    .font(.body)
                    .foregroundColor(.gray)
                ...
                Button {
                    ...
                    HStack {
                        ...
                        Text("Donation (Donatello / Buy Me a Coffee)")
                    }
                    .fontWeight(.semibold)
                    .foregroundColor(.white)
                    .padding()
